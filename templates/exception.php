...
<head>
    ...
    <style type="text/css">
        ...
        .theme-dark .copy-stacktrace svg path {
            fill: #787878;
        }
    ...
    <header>
        <div class="tools">
            ...
            <a href="https://www.google.com/search?<?= http_build_query(['q' => $throwable->getMessage()]) ?>" title="Search error on Google" target="_blank">
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M23.5309 9.825H12.2402V14.4656H18.6902C18.4121 15.9656 17.5684 17.2344 16.2965 18.0844C15.2215 18.8031 13.8496 19.2281 12.2371 19.2281C9.11523 19.2281 6.47461 17.1187 5.53086 14.2844C5.29336 13.5656 5.15586 12.7969 5.15586 12.0063C5.15586 11.2156 5.29336 10.4469 5.53086 9.72812C6.47774 6.89687 9.11836 4.7875 12.2402 4.7875C13.9996 4.7875 15.5777 5.39375 16.8215 6.58125L20.259 3.14062C18.1809 1.20312 15.4715 0.015625 12.2402 0.015625C7.55586 0.015625 3.50273 2.70312 1.53086 6.62187C0.71836 8.24062 0.255859 10.0719 0.255859 12.0094C0.255859 13.9469 0.71836 15.775 1.53086 17.3937C3.50273 21.3125 7.55586 24 12.2402 24C15.4777 24 18.1902 22.925 20.1715 21.0938C22.4371 19.0063 23.7465 15.9313 23.7465 12.2781C23.7465 11.4281 23.6715 10.6125 23.5309 9.825Z" fill="#989898"/>
                </svg>
            </a>
        </div>
        ...
        <div class="exception-card">
            ...
            <div>
                ...
                <a href="#" id="copy-stacktrace" title="Copy the stacktrace for use in a bug report or pastebin">
                    ...
                    <svg width="26" height="30" viewBox="0 0 26 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.0003 0.333344H3.33366C1.86699 0.333344 0.666992 1.53334 0.666992 3.00001V20.3333C0.666992 21.0667 1.26699 21.6667 2.00033 21.6667C2.73366 21.6667 3.33366 21.0667 3.33366 20.3333V4.33334C3.33366 3.60001 3.93366 3.00001 4.66699 3.00001H18.0003C18.7337 3.00001 19.3337 2.40001 19.3337 1.66668C19.3337 0.933343 18.7337 0.333344 18.0003 0.333344ZM23.3337 5.66668H8.66699C7.20033 5.66668 6.00033 6.86668 6.00033 8.33334V27C6.00033 28.4667 7.20033 29.6667 8.66699 29.6667H23.3337C24.8003 29.6667 26.0003 28.4667 26.0003 27V8.33334C26.0003 6.86668 24.8003 5.66668 23.3337 5.66668ZM22.0003 27H10.0003C9.26699 27 8.66699 26.4 8.66699 25.6667V9.66668C8.66699 8.93334 9.26699 8.33334 10.0003 8.33334H22.0003C22.7337 8.33334 23.3337 8.93334 23.3337 9.66668V25.6667C23.3337 26.4 22.7337 27 22.0003 27Z" fill="#989898"/>
                    </svg>
                </a>
            </div>
        </div>
