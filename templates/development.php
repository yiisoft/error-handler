...
<body<?= !empty($theme) ? " class=\"{$this->htmlEncode($theme)}\"" : '' ?>>
    <header>
        <div class="tools">
            <a href="#" title="Dark Mode" id="dark-mode">
                <svg width="28" height="28" fill="none" xmlns="https://www.w3.org/2000/svg">
        ...
        <div class="exception-card">
            ...
            <a href="#" id="copy-stacktrace" title="Copy the stacktrace for use in a bug report or pastebin">
                <svg width="26" height="30" fill="none" xmlns="https://www.w3.org/2000/svg">
    ...
    <main>
        ...
        <div class="footer">
            ...
            <svg width="256" height="224" fill="none" xmlns="https://www.w3.org/2000/svg">
                <g opacity=".54">
